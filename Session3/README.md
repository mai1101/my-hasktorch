...
## 3. linear regression model from scratch with sample data
...
epoch
- I set the epoch size large enough so that the learning curve shows the cost converging.
...
↑ The learning curve dropped smoothly and stabilized. 
